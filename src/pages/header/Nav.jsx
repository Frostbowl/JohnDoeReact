...
const Nav = () =>{
    return(
		<nav variant="underline" defaultActiveKey="/Home" className="navbar navbar-expand-lg  font-weight-bold text-light text-uppercase bg-dark " id="mainNav">
            <div className="container-fluid" >
                ...
                <div className="collapse navbar-collapse" id="navbar">
                    <ul className="navbar-nav ms-auto ">
                        ...
                        <li className="nav-item mx-0 mx-lg-1"><Link to='service' eventKey="" className="nav-link py-3 px-0 px-lg-3  text-white" >Services</Link></li>
